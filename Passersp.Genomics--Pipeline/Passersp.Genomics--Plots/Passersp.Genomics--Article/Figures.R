...
pacman::p_load(optparse, tidyverse, plyr, RColorBrewer, extrafont, ggforce, ggstar, ggrepel, RcppCNPy, reshape2, lemon, plotly,
               gridExtra, grid, extrafont, cowplot, patchwork, ggpubr, rphylopic, showtext)
...
PCA <- readRDS("../Y150239Genomics--PCA/PCA.rds")
Admix <- readRDS("../Y150239Genomics--ngsAdmix/ngsAdmix.rds")



Figure_1 <- PCA + Admix + plot_layout(ncol = 1)


# Save the final figure
ggsave(plot = Figure_1, "Figure_1.pdf",
       device = cairo_pdf, width = 18, height = 18, scale = 1, dpi = 600)
