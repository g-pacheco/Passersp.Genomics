...
# Writes result to be used in the GO Analysis ~
write.table(fulldf, "../Passersp.Genomics--GOAnalysis/Passersp.Genomics--TriangularR_AIMs_0.7.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
