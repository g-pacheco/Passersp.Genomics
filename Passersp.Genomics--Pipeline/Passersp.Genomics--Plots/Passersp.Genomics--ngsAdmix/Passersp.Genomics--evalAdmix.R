### The BEGINNING ~~~~~
##
# ~ Plots Passer sp. Genomics -- evalAdmix | Written by George Pacheco.
...
# Creates the panel ~
Passersp.Genomics_evalAdmix_Points_Plot <-
...
# Saves the panel ~
ggsave(Passersp.Genomics_evalAdmix_Points_Plot, file = "Passersp.Genomics--evalAdmix.pdf",
       device = cairo_pdf, width = 12, height = 14, scale = 1, dpi = 600)
ggsave(Passersp.Genomics_evalAdmix_Points_Plot, file = "Passersp.Genomics--evalAdmix.jpeg",
...
# Saves panel ~
ggsave(combined_plot, file = "Passersp.Genomics--evalAdmix.pdf",
       device = cairo_pdf, limitsize = FALSE, scale = 1, width = 14, height = 50, dpi = 600)
ggsave(combined_plot, file = "Passersp.Genomics--evalAdmix.jpeg",
