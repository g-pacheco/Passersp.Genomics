...
for (k in seq_along(annot_files)) {
  ...
  annot[[k]]$Population <- ifelse(grepl("FR0", annot[[k]]$Annot), "Sales",
                           ...
                           ifelse(grepl("PI22NLD0001M", annot[[k]]$Annot), "Focal Region",
                           ifelse(grepl("PD22NLD0146F", annot[[k]]$Annot), "Focal Region",
                           ifelse(grepl("PD22NLD0147F", annot[[k]]$Annot), "Focal Region",
                           ifelse(grepl("PDOM2022NLD0077M", annot[[k]]$Annot), "Focal Region",
...
fulldf <- final_long_format %>%
  mutate(Population_2 = ifelse(grepl("FR0", Sample_ID_2), "Sales",
                        ...
                        ifelse(grepl("PI22NLD0001M", Sample_ID_2), "Focal Region",
                        ifelse(grepl("PD22NLD0146F", Sample_ID_2), "Focal Region",
                        ifelse(grepl("PD22NLD0147F", Sample_ID_2), "Focal Region",
                        ifelse(grepl("PDOM2022NLD0077M", Sample_ID_2), "Focal Region",
...
ggsave(combined_plot, file = "Y150239Genomics--evalAdmix.pdf",
       device = cairo_pdf, limitsize = FALSE, scale = 1, width = 14, height = 42, dpi = 600)
